...
- Если seed ещё не запускался, первый вход `admin@outerhaven.local / Admin123!` автоматически создаёт админа Михаила.
...
- CORS настроен для `localhost:3000` и `127.0.0.1:3000` (чтобы вход работал и при открытии фронта по IP).
